...
__host__ __device__ void draw_point(int x, int y, color c, framebuffer* fb);
__host__ __device__ void draw_point(int x, int y, unsigned char color[4], framebuffer* fb);
